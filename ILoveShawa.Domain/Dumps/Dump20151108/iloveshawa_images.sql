...
CREATE TABLE `images` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`),
  KEY `IX_fk_image_shawarma_shop1` (`ShopId`),
  CONSTRAINT `fk_image_shawarma_shop1` FOREIGN KEY (`ShopId`) REFERENCES `shawashops` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-11-08 23:45:10
